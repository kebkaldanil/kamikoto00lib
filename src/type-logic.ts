...
>;
export type IsConvertableTo<
  T extends primitive<null>,
  E extends primitive<null>,
> = Or<Extends<T, E>, Extends<`${T}`, `${E}`>>;

export type If<C extends boolean, T, F = never> = C extends boolean
...
type IfElseHelper<T, D> = T extends [[infer E extends boolean, infer V], ...infer R]
  ...
  : D;
export type IfElse<T extends [boolean, unknown][], D = never> = number extends T["length"]
  ? D
  : IfElseHelper<T, D>;

export type Mor<A extends [boolean, ...boolean[]]> = A extends
  [infer C extends boolean, ...infer Rest extends [boolean, ...boolean[]]]
  ? Or<C, Mor<Rest>>
  : A[0];
export type Mand<A extends [boolean, ...boolean[]]> = A extends
  [infer C extends boolean, ...infer Rest extends [boolean, ...boolean[]]]
  ? And<C, Mand<Rest>>
  : A[0];
export type Mxor<A extends [boolean, ...boolean[]]> = A extends
  [infer C extends boolean, ...infer Rest extends [boolean, ...boolean[]]]
  ? Xor<C, Mxor<Rest>>
  : A[0];
export type Mnor<A extends [boolean, ...boolean[]]> = A extends
  [infer C extends boolean, ...infer Rest extends [boolean, ...boolean[]]]
  ? Nor<C, Mnor<Rest>>
  : A[0];
export type Mnand<A extends [boolean, ...boolean[]]> = A extends
  [infer C extends boolean, ...infer Rest extends [boolean, ...boolean[]]]
  ? Nand<C, Mnand<Rest>>
  : A[0];
export type Mnxor<A extends [boolean, ...boolean[]]> = A extends
  [infer C extends boolean, ...infer Rest extends [boolean, ...boolean[]]]
  ? Nxor<C, Mnxor<Rest>>
  : A[0];
